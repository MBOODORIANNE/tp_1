    ...
    >
      <View style={style.container}>
        ...
        <Image
          ...
          source={require("../assets/stacked-bar.png")}
        />
        <Image
          style={{
            position: "relative",
        ...
        <View style={style.cont1}>
          ...
          />
          <Image style={style.edite} source={require("../assets/orange.png")} />
          <Text
            style={{
              position: "relative",
              fontWeight: "bold",
        ...
        <View style={style.cont3}>
          <Image
            style={{ height: 100, width: 90, left: 50, top: 55 }}
